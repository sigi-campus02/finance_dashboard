...
class DimAccountTypes(models.Model):
    ...
    class Meta:
        ...
        managed = False  # Django soll Tabelle nicht verwalten
...
class FactAssetsLiabilitiesOverview(models.Model):
    ...
    # Zusätzliche Felder basierend auf deinem Schema
    # Passe diese an, falls die Spaltennamen in deiner DB anders sind
...
# Falls du weitere Tabellen für Kategorisierung hast, ergänze sie hier
# Beispiel:
class DimAssetCategory(models.Model):
    ...
    class Meta:
        db_table = 'dim_asset_category'  # Passe Tabellennamen an
        managed = False
